              ...
              <div>
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-gray-500 dark:text-gray-300">your.email@example.com</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-4 flex space-x-6">
                    ...
                    <a href="https://twitter.com/yourusername" className="text-gray-400 hover:text-gray-500">
